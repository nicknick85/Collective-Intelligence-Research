...
Here we describe the tables from the database contained in _pmdata.backup_. The best way to handle them is to use the function _GetData_ from _DataHandling.r_.
## tickdata_markets
