...
* File _PSys.RData_ is an _R_ workspace that contains some data from [our database](https://github.com/nicknick85/Prediction-Systems-Research/tree/master/Data) (tables _data12_ and _data13_) as well as all our scripts from the files described below.
## Data
